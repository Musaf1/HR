...
class _InterviewState extends State<Interview> {
  ...
  void initState() {
    super.initState();
    initShowDialog('select * from interview');
  }
                ...
                child: Card(
                    child: Row(
                      children: [
                        ...
                        Text("Interview: ${currentPersonList[index].ivt}",
                            style: const TextStyle(
                              fontWeight: FontWeight.w600,
                              fontSize: 20,
                              color: color3,
                        ...
                        IconButton(
                          ...
                          onPressed: () => Prosses().addPersonToJob(index, currentPersonList, context, this),
                        ),
                        IconButton(
                          color: Colors.red[300],
                          icon: const Icon(Icons.delete_outline),
                          onPressed: () => Prosses().deletePerson(
                              index, 'delete from interview  where id=?', currentPersonList, context, this),
                        ),
                        IconButton(
